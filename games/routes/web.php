...
Route::get('games/show/{id}', [App\Http\Controllers\GameController::class, 'showGame']);
...
Route::delete('games/delete/{id}', [App\Http\Controllers\GameController::class, 'destroy']);